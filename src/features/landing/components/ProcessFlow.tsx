...
export default function ProcessFlow() {
    return (
        <section className="py-20 bg-background-dark border-t border-white/5 relative overflow-hidden">
            <div className="absolute inset-0 map-pattern opacity-10"></div>

            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center mb-16">
                    <span className="text-accent font-semibold tracking-wider text-xs uppercase mb-2 block">Alur Partisipasi</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
                    <div className="hidden lg:block absolute top-12 left-[12%] right-[12%] h-0.5 bg-white/10 -z-10"></div>

                    <div className="flex flex-col items-center text-center group">
                        <div className="w-20 h-20 bg-[#530F25] rounded-full border border-white/10 flex items-center justify-center mb-6 shadow-lg group-hover:border-accent/50 group-hover:shadow-accent/20 transition-all duration-300">
                    ...
                    <div className="flex flex-col items-center text-center group">
                        <div className="w-20 h-20 bg-[#530F25] rounded-full border border-white/10 flex items-center justify-center mb-6 shadow-lg group-hover:border-accent/50 group-hover:shadow-accent/20 transition-all duration-300">
                            <FilePlus className="w-8 h-8 text-accent" />
                        </div>
                ...
                <div className="text-center mt-12">
                    <a href="#" className="inline-flex items-center text-accent hover:text-white font-semibold transition-colors">
