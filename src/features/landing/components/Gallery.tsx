            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                    <div>
                        ...
                        <p className="text-white/60">Pembaruan terkini seputar pembangunan dan kebijakan kota.</p>
                    </div>
                    <div className="flex bg-white/5 backdrop-blur-md rounded-lg p-1 border border-white/10 overflow-x-auto max-w-full">
                        <button className="px-4 py-2 rounded-md bg-accent/20 text-accent font-medium text-sm border border-accent/20 shadow-[0_0_15px_rgba(226,182,207,0.15)] whitespace-nowrap transition-all">
                            Berita
                        </button>
                        <button className="px-4 py-2 rounded-md text-white/50 hover:text-white hover:bg-white/5 font-medium text-sm whitespace-nowrap transition-all">
                            Panduan
                        </button>
                        <button className="px-4 py-2 rounded-md text-white/50 hover:text-white hover:bg-white/5 font-medium text-sm whitespace-nowrap transition-all">
                            Publikasi
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                    <div className="lg:col-span-7">
                        <div className="group relative h-full min-h-[400px] lg:min-h-[500px] rounded-2xl overflow-hidden border border-white/10 bg-card-dark bg-[#530F25]">
                            <img
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                                <div className="flex items-center gap-3 mb-4">
                                    <span className="px-2.5 py-1 rounded text-[10px] font-bold uppercase tracking-wider bg-primary text-white shadow-[0_0_10px_rgba(103,13,47,0.5)]">
                                        Infrastruktur
                                    </span>
                                ...
                                <p className="text-white/70 text-sm md:text-base line-clamp-2 mb-6 max-w-2xl font-light">
                    ...
                    <div className="lg:col-span-5 grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div className="group bg-[#530F25]/40 backdrop-blur-sm border border-white/5 rounded-xl overflow-hidden hover:bg-[#530F25]/60 transition-all hover:border-white/10 hover:shadow-lg hover:shadow-accent/5 flex flex-col">
                            <div className="h-40 overflow-hidden relative">
                                <div className="absolute top-3 left-3 z-10 px-2 py-0.5 rounded text-[10px] font-bold uppercase bg-accent/20 text-accent border border-accent/30 backdrop-blur-md">
                                    Digitalisasi
                                </div>
                                <img
                            ...
                            <div className="p-5 flex flex-col flex-grow">
                                <h4 className="text-white font-bold text-base mb-2 leading-snug group-hover:text-accent transition-colors line-clamp-2">
                                    Sosialisasi Aplikasi Musrenbang Digital Versi 2.0
                                </h4>
                                <div className="mt-auto pt-4 flex items-center justify-between border-t border-white/5">
                                    <span className="text-white/50 text-xs">10 Okt 2023</span>
                        ...
                        <div className="group bg-[#530F25]/40 backdrop-blur-sm border border-white/5 rounded-xl overflow-hidden hover:bg-[#530F25]/60 transition-all hover:border-white/10 hover:shadow-lg hover:shadow-accent/5 flex flex-col">
                            ...
                            <div className="p-5 flex flex-col flex-grow">
                                ...
                                <div className="mt-auto pt-4 flex items-center justify-between border-t border-white/5">
                                    <span className="text-white/50 text-xs">05 Okt 2023</span>
                                    <ArrowUpRight className="w-3.5 h-3.5 text-white/50 group-hover:text-white transition-colors" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="group bg-[#530F25]/40 backdrop-blur-sm border border-white/5 rounded-xl overflow-hidden hover:bg-[#530F25]/60 transition-all hover:border-white/10 hover:shadow-lg hover:shadow-accent/5 flex flex-col">
                            ...
                            <div className="p-5 flex flex-col flex-grow">
                                ...
                                <div className="mt-auto pt-4 flex items-center justify-between border-t border-white/5">
                                    <span className="text-white/50 text-xs">02 Okt 2023</span>
                                    <ArrowUpRight className="w-3.5 h-3.5 text-white/50 group-hover:text-white transition-colors" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="group bg-[#530F25]/40 backdrop-blur-sm border border-white/5 rounded-xl overflow-hidden hover:bg-[#530F25]/60 transition-all hover:border-white/10 hover:shadow-lg hover:shadow-accent/5 flex flex-col">
                            <div className="h-40 overflow-hidden relative">
                                ...
                                <div className="w-full h-full bg-[#3A0519] flex items-center justify-center">
                            ...
                            <div className="p-5 flex flex-col flex-grow">
                                ...
                                <div className="mt-auto pt-4 flex items-center justify-between border-t border-white/5">
                                    <span className="text-white/50 text-xs">28 Sep 2023</span>
                                    <ArrowUpRight className="w-3.5 h-3.5 text-white/50 group-hover:text-white transition-colors" />
                                </div>
                            </div>
                        </div>
                ...
                <div className="mt-12 text-center">
                    <a href="#" className="inline-flex items-center justify-center px-6 py-3 rounded-full border border-white/10 bg-white/5 hover:bg-white/10 text-white font-medium text-sm transition-all hover:border-accent/50 hover:shadow-[0_0_20px_rgba(226,182,207,0.2)] backdrop-blur-sm">
